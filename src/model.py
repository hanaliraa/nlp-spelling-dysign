...
class Model:
    ...
    def setup_ctc(self) -> None:
        ...
        # word beam search decoding (see https://github.com/githubharald/CTCWordBeamSearch)
            ...
            word_chars = open('nlp-spelling-dysign/model/wordCharList.txt').read().splitlines()[0]
            corpus = open('nlp-spelling-dysign/data/corpus.txt').read()
    ...
    def setup_tf(self) -> Tuple[tf.compat.v1.Session, tf.compat.v1.train.Saver]:
        ...
        model_dir = 'nlp-spelling-dysign/model/'
